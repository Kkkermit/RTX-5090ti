    ...
    async execute (interaction) {
        ...
        switch (sub) {
            ...
            const rule = await guild.autoModerationRules.create({
                name: `Block profinity, sexual content, and slurs by ${BotName}.`,
                creatorId: '1096437714439647243',
                enabled: true,
                eventType: 1,
                triggerType: 4,
                triggerMetadata: 
                ...
                actions: [
                    {
                        ...
                        metadata: {
                            ...
                            durationSeconds: 10,
                            customMessage: `This message was prevented by ${BotName}!`
                        }
                    }
                ]
            }).catch(async err => {
            ...
            const rule2 = await guild.autoModerationRules.create({
                name: `Prevent the word ${word} by ${BotName}.`,
                creatorId: '1096437714439647243',
                enabled: true,
                eventType: 1,
                triggerType: 1,
            ...
            const rule3 = await guild.autoModerationRules.create({
                name: `Prevent Spam Messages by ${BotName}.`,
                creatorId: '1096437714439647243',
                enabled: true,
                eventType: 1,
                triggerType: 5,
            ...
            const rule4 = await guild.autoModerationRules.create({
                name: `Prevent Spam Mentions by ${BotName}.`,
                creatorId: '1096437714439647243',
                enabled: true,
                eventType: 1,
                triggerType: 5,
